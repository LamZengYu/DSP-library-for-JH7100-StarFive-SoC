...
float* correlation_asm_f(float h[], float x[], int lenH, int lenX, int* lenY);
...
double* correlation_asm_d(double h[], double x[], int lenH, int lenX, int* lenY);
...
float* convolution_asm_f(float h[], float x[], int lenH, int lenX, int* lenY);
...
double* convolution_asm_d(double h[], double x[], int lenH, int lenX, int* lenY);
