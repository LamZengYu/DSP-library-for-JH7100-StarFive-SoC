...
main.o: example.c include/header.h
	$(CC) $(CFLAGS) -c example.c

src/fft/fft_opt_f.o: src/fft/fft_opt_f.c include/header.h
	$(CC) $(CFLAGS) -c src/fft/fft_opt_f.c -o src/fft/fft_opt_f.o

src/fft/fft_opt_d.o: src/fft/fft_opt_d.c include/header.h
	$(CC) $(CFLAGS) -c src/fft/fft_opt_d.c -o src/fft/fft_opt_d.o

src/convo/convolution_opt_f.o: src/convo/convolution_opt_f.c include/header.h
	$(CC) $(CFLAGS) -c src/convo/convolution_opt_f.c -o src/convo/convolution_opt_f.o

src/convo/convolution_opt_d.o: src/convo/convolution_opt_d.c include/header.h
	$(CC) $(CFLAGS) -c src/convo/convolution_opt_d.c -o src/convo/convolution_opt_d.o

src/corre/correlation_opt_f.o: src/corre/correlation_opt_f.c include/header.h
	$(CC) $(CFLAGS) -c src/corre/correlation_opt_f.c -o src/corre/correlation_opt_f.o

src/corre/correlation_opt_d.o: src/corre/correlation_opt_d.c include/header.h
